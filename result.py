...
ca_model = load('RandomForest_ModelCa.joblib')
hb_model = load('RandomForest_ModelHb.joblib')
gl_model = load('RandomForest_ModelGl.joblib')  # Assuming the same model for both hb and gl

# Load the dataset
df_ca = pd.read_csv("interpolatedca.csv")
df_hb = pd.read_csv("interpolatedHb.csv")
df_gl = pd.read_csv("interpolatedgl.csv")  # Assuming the same dataset for hb and gl
